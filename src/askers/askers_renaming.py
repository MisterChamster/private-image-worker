...
def ask_rename_action() -> Literal[
    ...
    "exit"]:
    returns_dict = {
        "pf": "print_dates_first_file",
        "pa": "print_all_dates",
        "ro": "rename_one_by_one",
        "ra": "rename_all_images",
    ...
    while True:
        print("Choose rename action:\n"
              "pf - Print all dates of the first file in folder...\n"
              "pa - Print all images names converted to a date format...\n"
              "ro - Rename images one by one...\n"
